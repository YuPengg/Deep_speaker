...
mfcc_001 = sample_from_mfcc(read_mfcc('samples/pengyu/pengyu_004.wav', SAMPLE_RATE), NUM_FRAMES)
mfcc_002 = sample_from_mfcc(read_mfcc('samples/pengyu/pengyu_005.wav', SAMPLE_RATE), NUM_FRAMES)

predict_001 = model.m.predict(np.expand_dims(mfcc_001, axis=0))
predict_002 = model.m.predict(np.expand_dims(mfcc_002, axis=0))

# mfcc_003 = sample_from_mfcc(read_mfcc('samples/1255-90413-0001.flac', SAMPLE_RATE), NUM_FRAMES)
mfcc_003 = sample_from_mfcc(read_mfcc('samples/lidakang_001.wav', SAMPLE_RATE), NUM_FRAMES)
